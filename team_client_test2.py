...
def main():
    try:
        ...
        # Try to list team members
        print("\n=== Team Members ===")
        members = dbx_team.team_members_list()
        print(f"Total team members: {len(members.members)}")
        
        for member in members.members:
            print(f"- {member.profile.name.display_name} ({member.profile.email})")
            ...
            if member.profile.email == "esteban.gastelut@propelland.com":
                ...
                your_member_id = member.profile.team_member_id
        ...
        print(f"=== Accessing User: {member.profile.name.display_name} ===")
